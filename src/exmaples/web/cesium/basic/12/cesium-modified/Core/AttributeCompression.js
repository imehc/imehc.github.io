 ...
 */
AttributeCompression.octEncodeInRange = (vector, rangeMax, result) => {
...
AttributeCompression.octEncode = (vector, result) =>
	AttributeCompression.octEncodeInRange(vector, 255, result);
 ...
 */
AttributeCompression.octEncodeToCartesian4 = (vector, result) => {
 ...
 * @see AttributeCompression.octEncodeInRange
 */
AttributeCompression.octDecodeInRange = (x, y, rangeMax, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("result", result);
 ...
 * @see AttributeCompression.octDecodeInRange
 */
AttributeCompression.octDecode = (x, y, result) =>
	AttributeCompression.octDecodeInRange(x, y, 255, result);
 ...
 *
 */
AttributeCompression.octDecodeFloat = (value, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
AttributeCompression.octUnpack = (packed, v1, v2, v3) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 *
 */
AttributeCompression.decompressTextureCoordinates = (compressed, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
AttributeCompression.decodeRGB565 = (typedArray, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("typedArray", typedArray);
