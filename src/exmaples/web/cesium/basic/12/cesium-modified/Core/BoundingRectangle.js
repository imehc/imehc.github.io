 ...
 * @returns {BoundingRectangle} The modified result parameter or a new BoundingRectangle instance if one was not provided.
 */
BoundingRectangle.fromRectangle = (rectangle, projection, result) => {
	if (!defined(result)) {
		result = new BoundingRectangle();
	}
 ...
 * @returns {BoundingRectangle} The modified result parameter or a new BoundingRectangle instance if one was not provided.
 */
BoundingRectangle.expand = (rectangle, point, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
BoundingRectangle.intersect = (left, right) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	//>>includeEnd('debug');
 ...
 */
BoundingRectangle.equals = (left, right) =>
	left === right ||
	(defined(left) &&
		defined(right) &&
		left.x === right.x &&
