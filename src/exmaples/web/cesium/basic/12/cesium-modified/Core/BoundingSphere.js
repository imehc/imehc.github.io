 ...
 */
BoundingSphere.fromPoints = (positions, result) => {
	if (!defined(result)) {
 ...
 */
BoundingSphere.fromRectangle2D = (rectangle, projection, result) =>
 ...
 */
BoundingSphere.fromVertices = (positions, center, stride, result) => {
	if (!defined(result)) {
		result = new BoundingSphere();
	}
 ...
 */
BoundingSphere.fromCornerPoints = (corner, oppositeCorner, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
BoundingSphere.fromEllipsoid = (ellipsoid, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {BoundingSphere} The modified result parameter or a new BoundingSphere instance if none was provided.
 */
BoundingSphere.fromOrientedBoundingBox = (orientedBoundingBox, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {BoundingSphere} The modified result parameter or a new BoundingSphere instance if none was provided.
 */
BoundingSphere.fromTransformation = (transformation, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
BoundingSphere.clone = (sphere, result) => {
	if (!defined(sphere)) {
		return undefined;
	}
 ...
 */
BoundingSphere.pack = (value, array, startingIndex) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {BoundingSphere} The modified result parameter or a new BoundingSphere instance if one was not provided.
 */
BoundingSphere.unpack = (array, startingIndex, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("array", array);
	//>>includeEnd('debug');
 ...
 * @returns {BoundingSphere} The modified result parameter or a new BoundingSphere instance if none was provided.
 */
BoundingSphere.expand = (sphere, point, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {BoundingSphere} The modified result parameter or a new BoundingSphere instance if none was provided.
 */
BoundingSphere.transform = (sphere, transform, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("sphere", sphere);
 ...
 * });
 */
BoundingSphere.distanceSquaredTo = (sphere, cartesian) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("sphere", sphere);
 ...
 */
BoundingSphere.transformWithoutScale = (sphere, transform, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("sphere", sphere);
	Check.typeOf.object("transform", transform);
	//>>includeEnd('debug');
 ...
 * @returns {BoundingSphere} The modified result parameter or a new BoundingSphere instance if none was provided.
 */
BoundingSphere.projectTo2D = (sphere, projection, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("sphere", sphere);
	//>>includeEnd('debug');
 ...
 */
BoundingSphere.isOccluded = (sphere, occluder) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("sphere", sphere);
 ...
 */
BoundingSphere.equals = (left, right) =>
	left === right ||
	(defined(left) &&
		defined(right) &&
