 ...
 * @see BoxGeometry.createGeometry
 */
BoxGeometry.fromDimensions = (options) => {
	options = options ?? Frozen.EMPTY_OBJECT;
 ...
 * @see BoxGeometry.createGeometry
 */
BoxGeometry.fromAxisAlignedBoundingBox = (boundingBox) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
BoxGeometry.pack = (value, array, startingIndex) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
BoxGeometry.unpack = (array, startingIndex, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("array", array);
	//>>includeEnd('debug');
 ...
 */
BoxGeometry.createGeometry = (boxGeometry) => {
