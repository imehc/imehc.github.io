 ...
 */
Cartesian3.fromSpherical = (spherical, result) => {
 ...
 */
Cartesian3.pack = (value, array, startingIndex) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {Cartesian3} The modified result parameter or a new Cartesian3 instance if one was not provided.
 */
Cartesian3.unpack = (array, startingIndex, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("array", array);
	//>>includeEnd('debug');
 ...
 */
Cartesian3.packArray = (array, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("array", array);
	//>>includeEnd('debug');
 ...
 */
Cartesian3.unpackArray = (array, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("array", array);
 ...
 */
Cartesian3.minimumComponent = (cartesian) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("cartesian", cartesian);
	//>>includeEnd('debug');
 ...
 */
Cartesian3.minimumByComponent = (first, second, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Cartesian3.maximumByComponent = (first, second, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("first", first);
	Check.typeOf.object("second", second);
	Check.typeOf.object("result", result);
 ...
 */
Cartesian3.clamp = (value, min, max, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("value", value);
 ...
 */
Cartesian3.magnitudeSquared = (cartesian) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("cartesian", cartesian);
	//>>includeEnd('debug');
 ...
 */
Cartesian3.magnitude = (cartesian) =>
	Math.sqrt(Cartesian3.magnitudeSquared(cartesian));
 ...
 */
Cartesian3.distance = (left, right) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Cartesian3.distanceSquared = (left, right) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	//>>includeEnd('debug');
 ...
 * @returns {Cartesian3} The modified result parameter.
 */
Cartesian3.multiplyComponents = (left, right, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	Check.typeOf.object("result", result);
 ...
 * @returns {Cartesian3} The modified result parameter.
 */
Cartesian3.divideComponents = (left, right, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	Check.typeOf.object("result", result);
 ...
 * @returns {Cartesian3} The modified result parameter.
 */
Cartesian3.subtract = (left, right, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	Check.typeOf.object("result", result);
 ...
 * @returns {Cartesian3} The modified result parameter.
 */
Cartesian3.multiplyByScalar = (cartesian, scalar, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("cartesian", cartesian);
 ...
 * @returns {Cartesian3} The modified result parameter.
 */
Cartesian3.divideByScalar = (cartesian, scalar, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("cartesian", cartesian);
	Check.typeOf.number("scalar", scalar);
	Check.typeOf.object("result", result);
 ...
 * @returns {Cartesian3} The modified result parameter.
 */
Cartesian3.abs = (cartesian, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("cartesian", cartesian);
	Check.typeOf.object("result", result);
	//>>includeEnd('debug');
 ...
 * @returns {Cartesian3} The modified result parameter.
 */
Cartesian3.lerp = (start, end, t, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Cartesian3.mostOrthogonalAxis = (cartesian, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("cartesian", cartesian);
	Check.typeOf.object("result", result);
	//>>includeEnd('debug');
 ...
 * @returns {Cartesian3} The modified result parameter
 */
Cartesian3.projectVector = (a, b, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("a", a);
	Check.defined("b", b);
 ...
 * @private
 */
Cartesian3.equalsArray = (cartesian, array, offset) =>
 ...
 */
Cartesian3.equalsEpsilon = (left, right, relativeEpsilon, absoluteEpsilon) =>
	left === right ||
	(defined(left) &&
		defined(right) &&
 ...
 */
Cartesian3.cross = (left, right, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	Check.typeOf.object("result", result);
 ...
 */
Cartesian3.midpoint = (left, right, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	Check.typeOf.object("result", result);
 ...
 */
Cartesian3.fromDegreesArray = (coordinates, ellipsoid, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Cartesian3.fromRadiansArray = (coordinates, ellipsoid, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("coordinates", coordinates);
	if (coordinates.length < 2 || coordinates.length % 2 !== 0) {
		throw new DeveloperError(
 ...
 */
Cartesian3.fromDegreesArrayHeights = (coordinates, ellipsoid, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("coordinates", coordinates);
 ...
 */
Cartesian3.fromRadiansArrayHeights = (coordinates, ellipsoid, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("coordinates", coordinates);
	if (coordinates.length < 3 || coordinates.length % 3 !== 0) {
		throw new DeveloperError(
