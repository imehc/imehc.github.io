 ...
 */
Color.fromCartesian4 = (cartesian, result) => {
 ...
 * @returns {Color} The modified result parameter or a new Color instance if one was not provided.
 */
Color.fromBytes = (red, green, blue, alpha, result) => {
 ...
 */
Color.fromAlpha = (color, alpha, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Color.fromHsl = (hue, saturation, lightness, alpha, result) => {
	hue = (hue ?? 0.0) % 1.0;
 ...
 * });
 */
Color.fromRandom = (options, result) => {
 ...
 */
Color.fromCssColorString = (color, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Color.pack = (value, array, startingIndex) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {Color} The modified result parameter or a new Color instance if one was not provided.
 */
Color.unpack = (array, startingIndex, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("array", array);
	//>>includeEnd('debug');
 ...
 */
Color.byteToFloat = (number) => number / 255.0;
 ...
 * @returns {number} The converted number.
 */
Color.floatToByte = (number) => (number === 1.0 ? 255.0 : (number * 256.0) | 0);
 ...
 * @private
 */
Color.equalsArray = (color, array, offset) =>
 ...
 * @see Color.toRgba
 */
Color.bytesToRgba = (red, green, blue, alpha) => {
	// scratchUint32Array and scratchUint8Array share an underlying array buffer
 ...
 * @returns {Color} The modified result parameter.
 */
Color.subtract = (left, right, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	Check.typeOf.object("result", result);
 ...
 * @returns {Color} The modified result parameter.
 */
Color.multiply = (left, right, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	Check.typeOf.object("result", result);
 ...
 * @returns {Color} The modified result parameter.
 */
Color.divide = (left, right, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	Check.typeOf.object("result", result);
 ...
 * @returns {Color} The modified result parameter.
 */
Color.multiplyByScalar = (color, scalar, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("color", color);
 ...
 * @returns {Color} The modified result parameter.
 */
Color.divideByScalar = (color, scalar, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("color", color);
	Check.typeOf.number("scalar", scalar);
	Check.typeOf.object("result", result);
