 ...
 */
ComponentDatatype.fromTypedArray = (array) => {
 ...
 * }
 */
ComponentDatatype.validate = (componentDatatype) =>
 ...
 */
ComponentDatatype.createTypedArray = (componentDatatype, valuesOrLength) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(componentDatatype)) {
 ...
 */
ComponentDatatype.fromName = (name) => {
	switch (name) {
		case "BYTE":
			return ComponentDatatype.BYTE;
		case "UNSIGNED_BYTE":
