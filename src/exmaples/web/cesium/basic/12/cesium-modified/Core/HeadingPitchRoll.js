 ...
 */
HeadingPitchRoll.fromQuaternion = (quaternion, result) => {
 ...
 */
HeadingPitchRoll.fromDegrees = (heading, pitch, roll, result) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(heading)) {
 ...
 */
HeadingPitchRoll.clone = (headingPitchRoll, result) => {
 ...
 */
HeadingPitchRoll.equals = (left, right) =>
	left === right ||
	(defined(left) &&
		defined(right) &&
