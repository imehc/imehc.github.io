 ...
 */
IntersectionTests.rayTriangleParametric = (ray, p0, p1, p2, cullBackFaces) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(ray)) {
		throw new DeveloperError("ray is required.");
	}
 ...
 * @returns {Cartesian3} The intersection point or undefined if there is no intersections.
 */
IntersectionTests.rayTriangle = (ray, p0, p1, p2, cullBackFaces, result) => {
 ...
 */
IntersectionTests.raySphere = (ray, sphere, result) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(ray)) {
		throw new DeveloperError("ray is required.");
	}
 ...
 * @returns {Interval} The interval containing scalar points along the ray or undefined if there are no intersections.
 */
IntersectionTests.lineSegmentSphere = (p0, p1, sphere, result) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(p0)) {
		throw new DeveloperError("p0 is required.");
	}
 ...
 */
IntersectionTests.rayAxisAlignedBoundingBox = (ray, box, result) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(ray)) {
		throw new DeveloperError("ray is required.");
	}
 ...
 */
IntersectionTests.lineSegmentPlane = (endPoint0, endPoint1, plane, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
IntersectionTests.trianglePlaneIntersection = (p0, p1, p2, plane) => {
	//>>includeStart('debug', pragmas.debug);
