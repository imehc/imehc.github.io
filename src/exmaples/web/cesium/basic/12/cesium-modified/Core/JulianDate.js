 ...
 */
JulianDate.fromGregorianDate = (date, result) => {
 ...
 */
JulianDate.fromDate = (date, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
JulianDate.fromIso8601 = (iso8601String, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {JulianDate} The modified result parameter or a new instance if none was provided.
 */
JulianDate.now = (result) => JulianDate.fromDate(new Date(), result);
 ...
 */
JulianDate.toGregorianDate = (julianDate, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
JulianDate.toIso8601 = (julianDate, precision) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(julianDate)) {
		throw new DeveloperError("julianDate is required.");
	}
 ...
 */
JulianDate.clone = (julianDate, result) => {
	if (!defined(julianDate)) {
		return undefined;
	}
	if (!defined(result)) {
 ...
 */
JulianDate.equalsEpsilon = (left, right, epsilon) => {
	epsilon = epsilon ?? 0;
 ...
 */
JulianDate.totalDays = (julianDate) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(julianDate)) {
		throw new DeveloperError("julianDate is required.");
	}
 ...
 */
JulianDate.secondsDifference = (left, right) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(left)) {
		throw new DeveloperError("left is required.");
	}
 ...
 */
JulianDate.daysDifference = (left, right) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(left)) {
		throw new DeveloperError("left is required.");
	}
 ...
 */
JulianDate.computeTaiMinusUtc = (julianDate) => {
	binarySearchScratchLeapSecond.julianDate = julianDate;
	const leapSeconds = JulianDate.leapSeconds;
	let index = binarySearch(
		leapSeconds,
 ...
 */
JulianDate.addSeconds = (julianDate, seconds, result) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(julianDate)) {
		throw new DeveloperError("julianDate is required.");
	}
 ...
 * @returns {JulianDate} The modified result parameter.
 */
JulianDate.addMinutes = (julianDate, minutes, result) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(julianDate)) {
		throw new DeveloperError("julianDate is required.");
	}
 ...
 * @returns {JulianDate} The modified result parameter.
 */
JulianDate.addHours = (julianDate, hours, result) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(julianDate)) {
		throw new DeveloperError("julianDate is required.");
	}
 ...
 * @returns {JulianDate} The modified result parameter.
 */
JulianDate.addDays = (julianDate, days, result) => {
	//>>includeStart('debug', pragmas.debug);
	if (!defined(julianDate)) {
		throw new DeveloperError("julianDate is required.");
	}
 ...
 */
JulianDate.lessThan = (left, right) => JulianDate.compare(left, right) < 0;
...
JulianDate.lessThanOrEquals = (left, right) =>
	JulianDate.compare(left, right) <= 0;
 ...
 */
JulianDate.greaterThan = (left, right) => JulianDate.compare(left, right) > 0;
