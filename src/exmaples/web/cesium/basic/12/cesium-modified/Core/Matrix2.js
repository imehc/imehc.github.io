 ...
 */
Matrix2.packArray = (array, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("array", array);
	//>>includeEnd('debug');
 ...
 */
Matrix2.unpackArray = (array, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("array", array);
 ...
 */
Matrix2.fromScale = (scale, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Matrix2.fromUniformScale = (scale, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Matrix2.fromRotation = (angle, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Matrix2.getElementIndex = (column, row) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Matrix2.getColumn = (matrix, index, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
 ...
 * @exception {DeveloperError} index must be 0 or 1.
 */
Matrix2.setColumn = (matrix, index, cartesian, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
 ...
 * @exception {DeveloperError} index must be 0 or 1.
 */
Matrix2.getRow = (matrix, index, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
 ...
 * @exception {DeveloperError} index must be 0 or 1.
 */
Matrix2.setRow = (matrix, index, cartesian, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
 ...
 */
Matrix2.setScale = (matrix, scale, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
	Check.typeOf.object("scale", scale);
	Check.typeOf.object("result", result);
 ...
 * @see Matrix2.getScale
 */
Matrix2.setUniformScale = (matrix, scale, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
	Check.typeOf.number("scale", scale);
	Check.typeOf.object("result", result);
 ...
 * @see Matrix2.setUniformScale
 */
Matrix2.getScale = (matrix, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
	Check.typeOf.object("result", result);
	//>>includeEnd('debug');
 ...
 */
Matrix2.getMaximumScale = (matrix) => {
 ...
 */
Matrix2.setRotation = (matrix, rotation, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
	Check.typeOf.object("result", result);
	//>>includeEnd('debug');
 ...
 * @see Matrix2.fromRotation
 */
Matrix2.getRotation = (matrix, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
	Check.typeOf.object("result", result);
	//>>includeEnd('debug');
 ...
 * @returns {Matrix2} The modified result parameter.
 */
Matrix2.subtract = (left, right, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	Check.typeOf.object("result", result);
 ...
 * @returns {Cartesian2} The modified result parameter.
 */
Matrix2.multiplyByVector = (matrix, cartesian, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
	Check.typeOf.object("cartesian", cartesian);
	Check.typeOf.object("result", result);
 ...
 * @see Matrix2.getScale
 */
Matrix2.multiplyByScale = (matrix, scale, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
	Check.typeOf.object("scale", scale);
	Check.typeOf.object("result", result);
 ...
 * @see Matrix2.getScale
 */
Matrix2.multiplyByUniformScale = (matrix, scale, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
	Check.typeOf.number("scale", scale);
	Check.typeOf.object("result", result);
 ...
 * @returns {Matrix2} The modified result parameter.
 */
Matrix2.transpose = (matrix, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("matrix", matrix);
	Check.typeOf.object("result", result);
	//>>includeEnd('debug');
 ...
 * @private
 */
Matrix2.equalsArray = (matrix, array, offset) =>
 ...
 */
Matrix2.equalsEpsilon = (left, right, epsilon) => {
	epsilon = epsilon ?? 0;
	return (
		left === right ||
		(defined(left) &&
