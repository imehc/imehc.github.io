 ...
 * @private
 */
PixelFormat.validate = (pixelFormat) =>
 ...
 * @private
 */
PixelFormat.isColorFormat = (pixelFormat) =>
	pixelFormat === PixelFormat.RED ||
	pixelFormat === PixelFormat.ALPHA ||
	pixelFormat === PixelFormat.RGB ||
	pixelFormat === PixelFormat.RGBA ||
 ...
 * @private
 */
PixelFormat.isDXTFormat = (pixelFormat) =>
	pixelFormat === PixelFormat.RGB_DXT1 ||
	pixelFormat === PixelFormat.RGBA_DXT1 ||
	pixelFormat === PixelFormat.RGBA_DXT3 ||
	pixelFormat === PixelFormat.RGBA_DXT5;
 ...
 * @private
 */
PixelFormat.isPVRTCFormat = (pixelFormat) =>
	pixelFormat === PixelFormat.RGB_PVRTC_4BPPV1 ||
	pixelFormat === PixelFormat.RGB_PVRTC_2BPPV1 ||
	pixelFormat === PixelFormat.RGBA_PVRTC_4BPPV1 ||
	pixelFormat === PixelFormat.RGBA_PVRTC_2BPPV1;
 ...
 * @private
 */
PixelFormat.isASTCFormat = (pixelFormat) =>
	pixelFormat === PixelFormat.RGBA_ASTC;

/**
 * @private
 */
PixelFormat.isETC1Format = (pixelFormat) =>
	pixelFormat === PixelFormat.RGB_ETC1;

/**
 * @private
 */
PixelFormat.isETC2Format = (pixelFormat) =>
	pixelFormat === PixelFormat.RGB8_ETC2 ||
	pixelFormat === PixelFormat.RGBA8_ETC2_EAC;
 ...
 * @private
 */
PixelFormat.isBC7Format = (pixelFormat) => pixelFormat === PixelFormat.RGBA_BC7;
 ...
 * @private
 */
PixelFormat.texture3DSizeInBytes = (
	pixelFormat,
	pixelDatatype,
	width,
	height,
 ...
 * @private
 */
PixelFormat.alignmentInBytes = (pixelFormat, pixelDatatype, width) => {
	const mod =
 ...
 */
PixelFormat.createTypedArray = (pixelFormat, pixelDatatype, width, height) => {
 ...
 * @private
 */
PixelFormat.flipY = (bufferView, pixelFormat, pixelDatatype, width, height) => {
	if (height === 1) {
		return bufferView;
	}
