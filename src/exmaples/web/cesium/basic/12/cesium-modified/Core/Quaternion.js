 ...
 */
Quaternion.fromRotationMatrix = (matrix, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Quaternion.pack = (value, array, startingIndex) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {Quaternion} The modified result parameter or a new Quaternion instance if one was not provided.
 */
Quaternion.unpack = (array, startingIndex, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("array", array);
	//>>includeEnd('debug');
 ...
 */
Quaternion.convertPackedArrayForInterpolation = (
	packedArray,
	startingIndex,
	lastIndex,
	result,
 ...
 * @returns {Quaternion} The modified result parameter or a new Quaternion instance if one was not provided.
 */
Quaternion.unpackInterpolationResult = (
	array,
	sourceArray,
	firstIndex,
	lastIndex,
 ...
 */
Quaternion.clone = (quaternion, result) => {
 ...
 */
Quaternion.conjugate = (quaternion, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Quaternion.magnitudeSquared = (quaternion) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("quaternion", quaternion);
	//>>includeEnd('debug');
 ...
 */
Quaternion.magnitude = (quaternion) =>
	Math.sqrt(Quaternion.magnitudeSquared(quaternion));
 ...
 * @returns {Quaternion} The modified result parameter.
 */
Quaternion.inverse = (quaternion, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("result", result);
	//>>includeEnd('debug');
 ...
 * @returns {Quaternion} The modified result parameter.
 */
Quaternion.subtract = (left, right, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("left", left);
	Check.typeOf.object("right", right);
	Check.typeOf.object("result", result);
 ...
 * @returns {Quaternion} The modified result parameter.
 */
Quaternion.negate = (quaternion, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("quaternion", quaternion);
	Check.typeOf.object("result", result);
	//>>includeEnd('debug');
 ...
 * @returns {Quaternion} The modified result parameter.
 */
Quaternion.multiplyByScalar = (quaternion, scalar, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("quaternion", quaternion);
 ...
 * @returns {Quaternion} The modified result parameter.
 */
Quaternion.divideByScalar = (quaternion, scalar, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("quaternion", quaternion);
	Check.typeOf.number("scalar", scalar);
	Check.typeOf.object("result", result);
 ...
 */
Quaternion.computeAxis = (quaternion, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("quaternion", quaternion);
	Check.typeOf.object("result", result);
	//>>includeEnd('debug');
 ...
 */
Quaternion.computeAngle = (quaternion) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("quaternion", quaternion);
	//>>includeEnd('debug');
 ...
 * @returns {Quaternion} The modified result parameter.
 */
Quaternion.lerp = (start, end, t, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {Cartesian3} The modified result parameter.
 */
Quaternion.log = (quaternion, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("quaternion", quaternion);
	Check.typeOf.object("result", result);
	//>>includeEnd('debug');
 ...
 * @returns {Quaternion} The modified result parameter.
 */
Quaternion.exp = (cartesian, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Quaternion.computeInnerQuadrangle = (q0, q1, q2, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Quaternion.squad = (q0, q1, s0, s1, t, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("q0", q0);
	Check.typeOf.object("q1", q1);
 ...
 * @see Quaternion#squad
 */
Quaternion.fastSquad = (q0, q1, s0, s1, t, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("q0", q0);
	Check.typeOf.object("q1", q1);
	Check.typeOf.object("s0", s0);
 ...
 */
Quaternion.equalsEpsilon = (left, right, epsilon) => {
	epsilon = epsilon ?? 0;
