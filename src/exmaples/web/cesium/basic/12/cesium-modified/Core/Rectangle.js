 ...
 */
Rectangle.pack = (value, array, startingIndex) => {
 ...
 */
Rectangle.unpack = (array, startingIndex, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.defined("array", array);
	//>>includeEnd('debug');
 ...
 */
Rectangle.computeWidth = (rectangle) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Rectangle.computeHeight = (rectangle) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
	//>>includeEnd('debug');
 ...
 */
Rectangle.fromDegrees = (west, south, east, north, result) => {
 ...
 */
Rectangle.fromRadians = (west, south, east, north, result) => {
	if (!defined(result)) {
		return new Rectangle(west, south, east, north);
	}
 ...
 * @returns {Rectangle} The modified result parameter or a new Rectangle instance if none was provided.
 */
Rectangle.fromCartographicArray = (cartographics, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {Rectangle} The modified result parameter or a new Rectangle instance if none was provided.
 */
Rectangle.fromCartesianArray = (cartesians, ellipsoid, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 * @returns {Rectangle} The modified result parameter or a new Rectangle instance if none was provided.
 */
Rectangle.fromBoundingSphere = (boundingSphere, ellipsoid, result) => {
	//>>includeStart('debug', pragmas.debug);
 ...
 */
Rectangle.clone = (rectangle, result) => {
 ...
 */
Rectangle.equalsEpsilon = (left, right, absoluteEpsilon) => {
 ...
 */
Rectangle.southwest = (rectangle, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
	//>>includeEnd('debug');
 ...
 * @returns {Cartographic} The modified result parameter or a new Cartographic instance if none was provided.
 */
Rectangle.northwest = (rectangle, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
	//>>includeEnd('debug');
 ...
 * @returns {Cartographic} The modified result parameter or a new Cartographic instance if none was provided.
 */
Rectangle.northeast = (rectangle, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
	//>>includeEnd('debug');
 ...
 * @returns {Cartographic} The modified result parameter or a new Cartographic instance if none was provided.
 */
Rectangle.southeast = (rectangle, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
	//>>includeEnd('debug');
 ...
 * @returns {Cartographic} The modified result parameter or a new Cartographic instance if none was provided.
 */
Rectangle.center = (rectangle, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
	//>>includeEnd('debug');
 ...
 */
Rectangle.intersection = (rectangle, otherRectangle, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
 ...
 * @returns {Rectangle|undefined} The modified result parameter, a new Rectangle instance if none was provided or undefined if there is no intersection.
 */
Rectangle.simpleIntersection = (rectangle, otherRectangle, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
	Check.typeOf.object("otherRectangle", otherRectangle);
	//>>includeEnd('debug');
 ...
 * @returns {Rectangle} The modified result parameter or a new Rectangle instance if none was provided.
 */
Rectangle.union = (rectangle, otherRectangle, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
	Check.typeOf.object("otherRectangle", otherRectangle);
	//>>includeEnd('debug');
 ...
 * @returns {Rectangle} The modified result parameter or a new Rectangle instance if one was not provided.
 */
Rectangle.expand = (rectangle, cartographic, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
 ...
 */
Rectangle.subsample = (rectangle, ellipsoid, surfaceHeight, result) => {
	//>>includeStart('debug', pragmas.debug);
	Check.typeOf.object("rectangle", rectangle);
	//>>includeEnd('debug');
