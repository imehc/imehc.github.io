 ...
 * @private
 */
RequestScheduler.serverHasOpenSlots = (serverKey, desiredRequests) => {
 ...
 * @private
 */
RequestScheduler.heapHasOpenSlots = (desiredRequests) => {
 ...
 * @private
 */
RequestScheduler.getServerKey = (url) => {
 ...
 * @private
 */
RequestScheduler.numberOfActiveRequestsByServer = (serverKey) =>
	numberOfActiveRequestsByServer[serverKey];
