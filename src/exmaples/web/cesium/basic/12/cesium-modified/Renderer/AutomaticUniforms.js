...
const AutomaticUniforms = {
	...
	czm_viewport: new AutomaticUniform({
		...
		getValue: (uniformState) => uniformState.viewportCartesian4,
	}),
	...
	czm_viewportOrthographic: new AutomaticUniform({
		...
		getValue: (uniformState) => uniformState.viewportOrthographic,
	}),
	...
	czm_viewportTransformation: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.viewportTransformation,
	}),
	...
	czm_globeDepthTexture: new AutomaticUniform({
		...
		getValue: (uniformState) => uniformState.globeDepthTexture,
	}),
	...
	czm_edgeIdTexture: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.SAMPLER_2D,
		getValue: (uniformState) => uniformState.edgeIdTexture,
	}),
	...
	czm_edgeColorTexture: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.SAMPLER_2D,
		getValue: (uniformState) => uniformState.edgeColorTexture,
	}),
	...
	czm_edgeDepthTexture: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.SAMPLER_2D,
		getValue: (uniformState) => uniformState.edgeDepthTexture,
	}),
	...
	czm_model: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.model,
	}),
	...
	czm_inverseModel: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.inverseModel,
	}),
	...
	czm_view: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.view,
	}),
	...
	czm_view3D: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.view3D,
	}),
	...
	czm_viewRotation: new AutomaticUniform({
		...
		getValue: (uniformState) => uniformState.viewRotation,
	}),
	...
	czm_viewRotation3D: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT3,
		getValue: (uniformState) => uniformState.viewRotation3D,
	}),
	...
	czm_inverseView: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.inverseView,
	}),
	...
	czm_inverseView3D: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.inverseView3D,
	}),
	...
	czm_inverseViewRotation: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT3,
		getValue: (uniformState) => uniformState.inverseViewRotation,
	}),
	...
	czm_inverseViewRotation3D: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT3,
		getValue: (uniformState) => uniformState.inverseViewRotation3D,
	}),
	...
	czm_projection: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.projection,
	}),
	...
	czm_inverseProjection: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.inverseProjection,
	}),
	...
	czm_infiniteProjection: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.infiniteProjection,
	}),
	...
	czm_modelView: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.modelView,
	}),
	...
	czm_modelView3D: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.modelView3D,
	}),
	...
	czm_modelViewRelativeToEye: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.modelViewRelativeToEye,
	}),
	...
	czm_inverseModelView: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.inverseModelView,
	}),
	...
	czm_inverseModelView3D: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.inverseModelView3D,
	}),
	...
	czm_viewProjection: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.viewProjection,
	}),
	...
	czm_inverseViewProjection: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.inverseViewProjection,
	}),
	...
	czm_modelViewProjection: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.modelViewProjection,
	}),
	...
	czm_inverseModelViewProjection: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.inverseModelViewProjection,
	}),
	...
	czm_modelViewProjectionRelativeToEye: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.modelViewProjectionRelativeToEye,
	}),
	...
	czm_modelViewInfiniteProjection: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.modelViewInfiniteProjection,
	}),
	...
	czm_orthographicIn3D: new AutomaticUniform({
		...
		getValue: (uniformState) => (uniformState.orthographicIn3D ? 1 : 0),
	}),
	...
	czm_normal: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT3,
		getValue: (uniformState) => uniformState.normal,
	}),
	...
	czm_normal3D: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT3,
		getValue: (uniformState) => uniformState.normal3D,
	}),
	...
	czm_inverseNormal: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT3,
		getValue: (uniformState) => uniformState.inverseNormal,
	}),
	...
	czm_inverseNormal3D: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT3,
		getValue: (uniformState) => uniformState.inverseNormal3D,
	}),
	...
	czm_eyeHeight: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.eyeHeight,
	}),
	...
	czm_eyeHeight2D: new AutomaticUniform({
		...
		getValue: (uniformState) => uniformState.eyeHeight2D,
	}),
	...
	czm_eyeEllipsoidNormalEC: new AutomaticUniform({
		...
		getValue: (uniformState) => uniformState.eyeEllipsoidNormalEC,
	}),
	...
	czm_eyeEllipsoidCurvature: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC2,
		getValue: (uniformState) => uniformState.eyeEllipsoidCurvature,
	}),
	...
	czm_modelToEnu: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.modelToEnu,
	}),
	...
	czm_enuToModel: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT4,
		getValue: (uniformState) => uniformState.enuToModel,
	}),
	...
	czm_entireFrustum: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC2,
		getValue: (uniformState) => uniformState.entireFrustum,
	}),
	...
	czm_currentFrustum: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC2,
		getValue: (uniformState) => uniformState.currentFrustum,
	}),
	...
	czm_frustumPlanes: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC4,
		getValue: (uniformState) => uniformState.frustumPlanes,
	}),
	...
	czm_farDepthFromNearPlusOne: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.farDepthFromNearPlusOne,
	}),
	...
	czm_log2FarDepthFromNearPlusOne: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.log2FarDepthFromNearPlusOne,
	}),
	...
	czm_oneOverLog2FarDepthFromNearPlusOne: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.oneOverLog2FarDepthFromNearPlusOne,
	}),
	...
	czm_sunPositionWC: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.sunPositionWC,
	}),
	...
	czm_sunPositionColumbusView: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.sunPositionColumbusView,
	}),
	...
	czm_sunDirectionEC: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.sunDirectionEC,
	}),
	...
	czm_sunDirectionWC: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.sunDirectionWC,
	}),
	...
	czm_moonDirectionEC: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.moonDirectionEC,
	}),
	...
	czm_lightDirectionEC: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.lightDirectionEC,
	}),
	...
	czm_lightDirectionWC: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.lightDirectionWC,
	}),
	...
	czm_lightColor: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.lightColor,
	}),
	...
	czm_lightColorHdr: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.lightColorHdr,
	}),
	...
	czm_encodedCameraPositionMCHigh: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.encodedCameraPositionMCHigh,
	}),
	...
	czm_encodedCameraPositionMCLow: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.encodedCameraPositionMCLow,
	}),
	...
	czm_viewerPositionWC: new AutomaticUniform({
		...
		getValue: (uniformState) =>
			Matrix4.getTranslation(uniformState.inverseView, viewerPositionWCScratch),
	}),
	...
	czm_frameNumber: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.frameState.frameNumber,
	}),
	...
	czm_morphTime: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.frameState.morphTime,
	}),
	...
	czm_sceneMode: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.frameState.mode,
	}),
	...
	czm_pass: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.pass,
	}),
	...
	czm_backgroundColor: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC4,
		getValue: (uniformState) => uniformState.backgroundColor,
	}),
	...
	czm_brdfLut: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.SAMPLER_2D,
		getValue: (uniformState) => uniformState.brdfLut,
	}),
	...
	czm_environmentMap: new AutomaticUniform({
		...
		getValue: (uniformState) => uniformState.environmentMap,
	}),
	...
	czm_specularEnvironmentMaps: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.SAMPLER_CUBE,
		getValue: (uniformState) => uniformState.specularEnvironmentMaps,
	}),
	...
	czm_specularEnvironmentMapsMaximumLOD: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.specularEnvironmentMapsMaximumLOD,
	}),
	...
	czm_sphericalHarmonicCoefficients: new AutomaticUniform({
		size: 9,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.sphericalHarmonicCoefficients,
	}),
	...
	czm_temeToPseudoFixed: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_MAT3,
		getValue: (uniformState) => uniformState.temeToPseudoFixedMatrix,
	}),
	...
	czm_pixelRatio: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.pixelRatio,
	}),
	...
	czm_fogDensity: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.fogDensity,
	}),
	...
	czm_fogVisualDensityScalar: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.fogVisualDensityScalar,
	}),
	...
	czm_fogMinimumBrightness: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.fogMinimumBrightness,
	}),
	...
	czm_atmosphereHsbShift: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.atmosphereHsbShift,
	}),
	/**
	...
	czm_atmosphereLightIntensity: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.atmosphereLightIntensity,
	}),
	/**
	...
	czm_atmosphereRayleighCoefficient: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.atmosphereRayleighCoefficient,
	}),
	/**
	...
	czm_atmosphereRayleighScaleHeight: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.atmosphereRayleighScaleHeight,
	}),
	/**
	...
	czm_atmosphereMieCoefficient: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.atmosphereMieCoefficient,
	}),
	/**
	...
	czm_atmosphereMieScaleHeight: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.atmosphereMieScaleHeight,
	}),
	/**
	...
	czm_atmosphereMieAnisotropy: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.atmosphereMieAnisotropy,
	}),
	...
	czm_atmosphereDynamicLighting: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.atmosphereDynamicLighting,
	}),
	...
	czm_splitPosition: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.splitPosition,
	}),
	...
	czm_geometricToleranceOverMeter: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.geometricToleranceOverMeter,
	}),
	...
	czm_minimumDisableDepthTestDistance: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.minimumDisableDepthTestDistance,
	}),
	...
	czm_invertClassificationColor: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC4,
		getValue: (uniformState) => uniformState.invertClassificationColor,
	}),
	...
	czm_gamma: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT,
		getValue: (uniformState) => uniformState.gamma,
	}),
	...
	czm_ellipsoidRadii: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.ellipsoid.radii,
	}),
	...
	czm_ellipsoidInverseRadii: new AutomaticUniform({
		size: 1,
		datatype: WebGLConstants.FLOAT_VEC3,
		getValue: (uniformState) => uniformState.ellipsoid.oneOverRadii,
	}),
};
