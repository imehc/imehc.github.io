...
function CubeMap(options) {
	...
	// 只在 ContextLimits 已初始化时才检查 cube map 大小
	if (
		ContextLimits.maximumCubeMapSize > 0 &&
		size > ContextLimits.maximumCubeMapSize
	) {
		throw new DeveloperError(
 ...
 * @private
 */
CubeMap.faceNames = () => makeFaceNamesIterator();
 ...
 */
CubeMap.getDirection = (face, result) => {
	switch (face) {
...
CubeMap.prototype.isDestroyed = () => false;
